...
function genClap8() {
	let clap8=[0.3,0.7,-0.1,0.4,0,-0.5,-3,-0.2,0.5,0.6,0.2,-0.3,-0.9,-0.1,0.5,0.8,1,0.4,-0.6,-0.1,0.3,0.7,1,0.4,0,-0.5,-0.1,-0.2,0.5,0.6,0.2,-0.3,-0.9,-0.1,0.5,0.8,0.1,0.4,-0.6,-0.1];
	let d=0.3;
	let dr=50;
	let l=1;
