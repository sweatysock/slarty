...
//	outDataV = outAudioV.slice();					// Faster way to copy venue audio to it's special output
	...
	if (echoRisk) {
		...
		else if (tempThresh > gap) tempThresh = 0.8;		// Between gap and 0.5 there is a chance of interrupting if you shout or clap
		else if (tempThresh > gap*0.3) tempThresh = 0.3;	// and for slightly lower levels there is a slightly more tolerant gap kept open
